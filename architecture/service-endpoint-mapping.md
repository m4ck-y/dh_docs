...
|----------|--------|-------------------|---------------------|----------------|--------|
| `api_middleware` (gateway) | 8000 | N/A | `/api/middleware` | `["*"]` | Activo |
...
| `dh_onboarding_back` | 8085 | `/api/middleware/onboarding` | `/api/onboarding` | `["*"]` | Activo |
...
| `app_message_sender` | 8091 | `/api/middleware/message_sender` | `/api/message_sender` | `["*"]` | Testing |
| `app_logger_tracer` | 8092 | `/api/middleware/logger_tracer` | `/api/logger_tracer` | `["*"]` | Testing |
