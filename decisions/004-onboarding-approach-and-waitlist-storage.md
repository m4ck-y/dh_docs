...
2. **Waitlist en MongoDB (dentro de dh_onboarding)**: La Waitlist (leads interesados) se mantendrá en **MongoDB** utilizando **Beanie ODM**.
    - estará contenida dentro del microservicio `dh_onboarding` para mantener cohesión, ya que waiting y onboarding forman un flujo continuo.
