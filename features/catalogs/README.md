...
Vocabularios que vienen de **fuera** (estándar + sync), mayormente **masivos**
(ClickHouse, solo lectura). Se clasifican **por pregunta** al crear cada
ficha/bank (regla: [`clinical_history/sections/README.md`](../clinical_history/sections/README.md#enum-o-catálogo)).

| Catálogo | Motor | Notas |
|---|---|---|
