...
- **1.1.17 ¿El usuario depende económicamente de usted?** _(condicional)_
  - 1.1.17.1 Sí
...
- **1.2.12A Género** ⚠️ _(agregado: estaba en el `.mmd`, faltaba en la ficha)_
  - 1.2.12A.1 Femenino
  - 1.2.12A.2 Masculino
...
- **1.2.18 Ingresos** ⚠️ _(opciones del `.mmd`; la ficha previa usaba rangos de $)_
...
- **1.2.19 ¿Cuántas personas dependen económicamente de usted?** ⚠️ _(agregado: estaba en el `.mmd`, faltaba en la ficha)_
  - 1.2.19.1 Ninguna
  - 1.2.19.2 1
  - 1.2.19.3 2
  - 1.2.19.4 3 o más
