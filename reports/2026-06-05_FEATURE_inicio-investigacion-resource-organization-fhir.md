...
2. **Asociación de Recursos de Salud**: Servirá como pilar central de referencia para vincular pacientes (médicos o clínicas a cargo de su expediente), personal médico ([`Practitioner`](https://hl7.org/fhir/R5/practitioner.html)) y ubicaciones físicas ([`Location`](https://hl7.org/fhir/R5/location.html)).
...
- **Relaciones con el Recurso [`Location`](https://hl7.org/fhir/R5/location.html)**: Mapeo preliminar de cómo vincular una entidad administrativa con sus locaciones físicas y salas de hospitalización.
