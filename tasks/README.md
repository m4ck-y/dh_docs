...
- `planning/`: Plan de ejecución y análisis técnico.
- `progress/`: Registros de sesión diarios.
- `artifacts/`: Scripts, diagramas y otros archivos temporales.
- `README.md`: Resumen y estado de la tarea.
